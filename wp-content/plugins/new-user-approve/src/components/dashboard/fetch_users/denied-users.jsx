...
const Denied_Users = () => {
    ...
    return (
        ...
        <TableContainer className="denied_users_tbl_container usersTable" component={Paper}>
            ...
            usersData.map((row) => (
                    ...
                    <TableCell align="center" className='user-action-btn'>
                        {action_status( row.nua_status ).map((status) => (
                                ...
                                { user_id === row.ID && loading == true ?  <div className='new-user-approve-loading'><div className="nua-spinner"></div></div> : <span className="loadEmpty" style={{marginLeft:13}}></span> }
